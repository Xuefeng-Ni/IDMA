    ...
    def simple_test_bboxes(self, feats, img_metas, rescale=False):
        ...
        Returns:
            list[tuple[Tensor, Tensor]]: Each item in result_list is 2-tuple.
                ...
                with shape (n,)
        """
##        feats, att = feats      #att_loss
        outs = self.forward(feats)

        #feature visualization
##        plt.imsave('/home/nxf/IDMA/work_dirs/tood_pvt_v2_b2_ssfpn_3x_mstrain_fp16_casiou_repeat_2/output_features/'+img_metas[0]['ori_filename'], outs[2])
##        outs = outs[:-1]
